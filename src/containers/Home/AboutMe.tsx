...
const AboutMe: React.FC = () => {
  ...
  return (
    <section className="bg-[#223975] px-20 py-20 max-sm:pt-20 flex flex-col gap-12 rounded-[50px] items-center mt-4 ">
      ...
      <div className="flex w-full gap-6 justify-center flex-wrap max-lg:items-center">
